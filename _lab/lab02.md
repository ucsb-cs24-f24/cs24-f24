...
As you can see, none of the functions do anything at the moment, but you can start by implementing the constructor and `insert` methods since these will serve as the foundation for future testing.
